...
- Understanding Git terminology is key to mastering version control.
- Git uses a specific set of terms to describe the state of your code, how it is stored, and how changes are moved between different environments. 
...
## 18. Main Branch
Default primary branch of a repository.
